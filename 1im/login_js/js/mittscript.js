...
function variablerFraForm(){
	...
	variabel_brukernavn = document.getElementById("brukernavn");
	variabel_passord = document.getElementById("passord");
...
*/	
	// lage det som skal vises i html-filen i variabelen myOutput
	//

	myOutput = "Hei " + variabel_brukenavn + " !"input_2";
